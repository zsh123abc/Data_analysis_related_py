...
if __name__ == '__main__':
    # 遍历待加入图片
    dirss = (r'D:\zsh\biaozhu\bilibli\download\snd_court_1\snd_court_img_test') # 图片路径
    dirss2 = (r'D:\zsh\biaozhu\bilibli\download\snd_court_1\snd_court_img_test') # 图片反转后存放路径
