...
class_names = [ 'basketball','basketball_frame', 'person' ,'backboard', 'basket_net', 'zz', 'zx', 'dt']


xmlpath = r'D:\zsh\biaozhu\4.6_toulan\5000img\img_5000\img859\xml/'  # 原xml路径
txtpath = r'D:\zsh\biaozhu\4.6_toulan\5000img\img_5000\img859\labels/'  # 转换后txt文件存放路径
files = []
